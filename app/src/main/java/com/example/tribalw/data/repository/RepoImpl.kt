package com.example.tribalw.data.repository
...
class RepoImpl @Inject constructor(val localDataSource: LocalDataSourceInterface) : RepoInterface {

    override suspend fun saveNoteRoomRepo(noteEntity: NoteEntity) {
        localDataSource.saveNoteRoom(noteEntity)
    }

    override suspend fun getAllNoteRoomRepo(): Resource<List<NoteEntity>> = localDataSource.getAllNoteRoom()
}