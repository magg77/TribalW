package com.example.tribalw.domain
...
class UserCaseNote @Inject constructor(private val repoInterface: RepoInterface) : UserCaseNoteContract {

    override suspend fun saveNoteRoomContract(noteEntity: NoteEntity) = repoInterface.saveNoteRoomRepo(noteEntity)

    override suspend fun getAllNoteRoomContract(): Resource<List<NoteEntity>> = repoInterface.getAllNoteRoomRepo()
}