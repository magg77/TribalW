...
import com.example.tribalw.core.valueObject.AppDatabaseRoom
...
object RoomModule {
    ...
    private const val TABLE_NAME_NOTE_ENTITY = "note_entity"
    ...
    fun provideRoomInstance(@ApplicationContext context: Context) = synchronized(this) {
        Room.databaseBuilder(
            ...
            TABLE_NAME_NOTE_ENTITY
        ).build()
    }

    @Singleton
    @Provides
    fun providesNoteEntityDao(db: AppDatabaseRoom) = db.noteDato()
