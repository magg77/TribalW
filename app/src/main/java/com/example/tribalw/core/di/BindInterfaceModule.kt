package com.example.tribalw.core.di

import com.example.tribalw.data.provider.local.serviceLocal.LocalDataSourceImpl
import com.example.tribalw.data.provider.local.serviceLocal.LocalDataSourceInterface
import com.example.tribalw.data.repository.RepoImpl
import com.example.tribalw.data.repository.RepoInterface
import com.example.tribalw.domain.UserCaseNote
import com.example.tribalw.domain.UserCaseNoteContract
import dagger.Binds
...
abstract class BindInterfaceModule {
    ...
    @Binds
    abstract fun bindUserCase(userCase: UserCaseNote) : UserCaseNoteContract

    @Binds
    abstract fun bindRepoImpl(repo: RepoImpl) : RepoInterface

    @Binds
    abstract fun localDataSource(localDataSource: LocalDataSourceImpl) : LocalDataSourceInterface
